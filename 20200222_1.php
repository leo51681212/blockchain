...
<body>
 ...
 <div>
    <input type="text" id="pay" value="1"></br>
...
async function init(){
        ...
        init(); 
        async function Pay(){
     document.getElementById("pay").innerHTML="version"; 
...
async function Pay1(){
      ...
      var accounts = await web3.eth.defaultAccount;
document.getElementById("pay").innerHTML=accounts;
